...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-174902584-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-174902584-1');
</script>
...
<div class="row" style="text-align: left">
    ...
    <div class="col-md-8" style="margin-left: 2%;margin-top: 2%">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            Một số chức năng sẽ tạm khoá trong bản Demo !
            <button type="button" class="close" data-dismiss="alert" aria-label="Đóng"><span aria-hidden="true">×</span></button>
        </div>
    </div>
</div>
@endif
