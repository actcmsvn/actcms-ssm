                ...
                <div class="card py-3 m-b-30">
                    <div class="card-body">
                        <p>ID đơn hàng: #{{ $order->id }}
                            <span style="float:right"><a href="{{ Asset(env('staff').'/deliverOrder/'.$order->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-sm m-b-15 ml-2 mr-2 btn-success">Giao hàng</a></span>
                        </p>
                        <hr>
