...
<a href="{{ Asset('orderStatus?id='.$row->id.'&status=1') }}" onclick="return confirm('Are you sure?')">Xác nhận đơn hàng</a><hr>

<a href="{{ Asset('orderStatus?id='.$row->id.'&status=2') }}" onclick="return confirm('Are you sure?')">Huỷ đơn hàng</a><hr>
...
<a href="{{ Asset('orderStatus?id='.$row->id.'&status=4') }}" onclick="return confirm('Are you sure?')">Gởi đơn hàng</a><hr>
...
<a href="{{ Asset('orderStatus?id='.$row->id.'&status=2') }}" onclick="return confirm('Are you sure?')" style="color:red">Huỷ đơn hàng</a>
